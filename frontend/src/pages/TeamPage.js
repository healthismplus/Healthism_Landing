...
const TeamMemberCard = ({ member, category }) => (
  ...
  >
    <div className="h-20" style={{ background: 'linear-gradient(135deg, #0A2725 0%, #0F3D3A 100%)' }}></div>
...
const TeamPage = () => {
  ...
  return (
    <div className="min-h-screen" style={{ background: '#F8F9FA' }}>
      {/* Header */}
      <div className="py-20 px-6 md:px-12" style={{ background: 'linear-gradient(135deg, #0A2725 0%, #0F3D3A 100%)' }}>
        <div className="max-w-7xl mx-auto">
          <motion.button
            ...
            whileHover={{ x: -5 }}
            onClick={() => navigate('/')}
            className="flex items-center gap-2 text-white mb-8 hover:text-[#13B58E] transition-colors"
          ...
          >
            ...
            >
              {leadership.map((member, i) => (
                <TeamMemberCard key={i} member={member} category="leadership" />
              ))}
            </motion.div>
          </motion.div>
        </div>
      ...
      {/* CTA Section */}
      <section className="py-16 px-6 md:px-12" style={{ background: 'linear-gradient(135deg, #0A2725 0%, #0F3D3A 100%)' }}>
