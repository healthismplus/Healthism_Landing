  ...
  return (
    ...
    >
      <div
        ...
        style={{ fontFamily: "Raleway", color: "#1AAC8B" }}
      >
        {prefix}
...
function HomePage() {
  ...
  return (
    <div className="App page-wrapper">
      ...
      >
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          >
            <motion.div
              variants={fadeUp}
              className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[#1AAC8B] mb-6"
              data-testid="hero-badge"
            >
              <span className="pulse-dot w-2 h-2 rounded-full bg-[#1AAC8B]"></span>
              <span className="text-sm text-[#1AAC8B] font-medium">
                India's Leading Health-Tech Platform
              </span>
            </motion.div>
            ...
            >
              Graceful Health · Preventive Living · Empowered Wellness. Less
              Paperwork, More Patient Care.
            </motion.p>
          ...
          >
            ...
            >
              ...
              <p className="text-sm text-white/70">
                Hindi, English & Marathi voice booking
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-sm text-white/70">
                ABHA-integrated health records
              </p>
            </motion.div>
          </motion.div>
            ...
            {[
              {
                ...
                desc: "Save 20-70% on healthcare services with trusted partner network",
              },
              {
                icon: "🔗",
                title: "One Connected Platform",
                desc: "Seamlessly integrates hospitals, wellness centers, and health experts",
              },
              {
                icon: "📊",
                title: "Data Empowerment",
                desc: "ABHA-integrated digital health locker with complete health history",
              },
              {
                icon: "🎮",
                title: "Gamified Prevention",
                desc: "12-week Fad 2 Fit program making wellness engaging and achievable",
              },
            ].map((item, i) => (
              <motion.div
                key={i}
        ...
        <AnimatedSection className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <motion.div variants={staggerContainer}>
              ...
              {[
                {
                  title: "Complete Hospital Administration",
                  desc: "Unified system for OPD, IPD, ICU, and OT management",
                },
                {
                  title: "AI Virtual Receptionist & Speak Bot",
                  desc: "Multi-language voice booking in Hindi, English & Marathi",
                },
                {
                  title: "Advanced Clinical Assistance for Doctors",
                  desc: "Smart prescriptions, voice notes, and AI-powered suggestions",
                },
                {
                  title: "IPD & Ward Management",
                  desc: "Real-time patient tracking, medication management, and digital handovers",
                },
              ].map((feature, i) => (
                <motion.div
                  key={i}
            ...
            <motion.div
              ...
              style={{
                background: "linear-gradient(135deg, #091A3A, #0F2A5C)",
              }}
              ...
              <div className="space-y-3">
                ...
                >
                  ...
                  <div className="flex gap-2 flex-wrap">
                    <motion.span
                      ...
                      style={{
                        background: "rgba(26, 172, 139, 0.2)",
                        color: "#22C9A5",
                      }}
                    >
                      OPD: 42
                ...
                >
                  <div className="flex justify-between items-center">
                    ...
                    <div className="text-[#1AAC8B] text-sm font-semibold">
                      ↑ 12%
                    </div>
                  </div>
                </motion.div>
      ...
      <section
        id="plans"
        className="py-16 px-6 md:px-12 bg-white overflow-hidden"
          ...
          >
            {plans.map((plan, i) => (
              <motion.div
                ...
                style={
                  !plan.featured
                    ? { border: "1.5px solid rgba(26, 172, 139, 0.15)" }
                    : {}
                }
              ...
              >
                ...
                <h3
                  ...
                  style={{
                    fontFamily: "Raleway",
                    color: plan.featured ? "white" : "#091A3A",
                  }}
                >
                  {plan.name}
                </h3>
                <ul
                  ...
                  style={{
                    color: plan.featured ? "rgba(255,255,255,0.8)" : "#6B7A99",
                  }}
                >
        ...
        <AnimatedSection className="max-w-7xl mx-auto">
          ...
          <div className="mb-6 overflow-hidden">
            <div className="flex gap-3 marquee">
              {[...healthcarePartners, ...healthcarePartners].map(
                (partner, i) => (
                  <motion.div
                    key={i}
        ...
        <AnimatedSection className="max-w-7xl mx-auto">
          <motion.div variants={fadeUp} className="mb-12 text-center">
            ...
            <p className="text-[#6B7A99]">
              The visionaries behind HealthismPlus
            </p>
          </motion.div>
