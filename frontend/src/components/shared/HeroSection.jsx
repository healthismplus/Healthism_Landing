...
const HeroSection = ({ activeTab, setActiveTab, onContactClick }) => {
  ...
  return (
    <>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center py-8 lg:py-16">
            ...
            >
              ...
              >
                ...
                <span className="text-sm text-[#13B58E] font-semibold tracking-wide" style={{ fontFamily: 'Raleway' }}>HEALTHCARE REDEFINED</span>
              </motion.div>
              ...
              >
                Experience the future of healthcare with an all-in-one ecosystem designed for preventative wellness, instant care, and AI-driven insights.
              </motion.p>
          ...
          >
            {stats.map((stat, i) => (
              <div key={i} className="text-center">
                <div className="text-3xl md:text-4xl font-extrabold text-[#13B58E] mb-1" style={{ fontFamily: 'Raleway' }}>
                  {stat.number}
                </div>
      ...
      <section className="py-16 px-6 lg:px-12 bg-white" data-testid="tab-switcher-section">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-extrabold text-[#1A1A1A] mb-3" style={{ fontFamily: 'Raleway' }}>
              Who Are You Here For?
            </h2>
            <p className="text-[#6B7A99] mb-10 max-w-xl mx-auto text-sm">
              Select the journey that best fits your needs to explore tailored healthcare solutions.
            </p>

            <div className="flex flex-wrap justify-center gap-3" data-testid="user-type-tabs">
              {tabs.map((tab) => (
                <motion.button
                  key={tab.id}
